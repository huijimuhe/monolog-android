...
public class StatueListAdapter extends AbstractRenderAdapter<Statue> {

    private Account mUser;

    public StatueListAdapter(ArrayList<Statue> statues, int type) {
        this.mDataset = statues;
        this.mViewType = type;
    }

    public StatueListAdapter(ArrayList<Statue> statues, int type, Account user) {
        this.mDataset = statues;
        this.mViewType = type;
        this.mUser = user;
    }
    ...
    public AbstractViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case StatueContract.RENDER_TYPE_MY_PROFILE:
                ProfileRender profile =new ProfileRender(viewGroup, this, StatueContract.RENDER_TYPE_MY_PROFILE, mUser);
            ...
            case StatueContract.RENDER_TYPE_OTHER_PROFILE:
                ProfileRender profile2 =new ProfileRender(viewGroup, this, StatueContract.RENDER_TYPE_OTHER_PROFILE, mUser);
